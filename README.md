...
[Without Face Bluring Demo]("Real Time Face Detection/face_detection_demo_without_blur.mkv")

- **With Face Bluring**:

[With Face Bluring Demo]("Real Time Face Detection/face_detection_demo_with_blur.mkv")
